...
% decision variable
function [optimized, opt_res] = RUN_COL_noGrad(seed, modelParam, collParam ) %TD_angle should be nan unless it is dictated
...
%     dr0 = ub(1+5*cp:6*cp); %dr0
    ...
    collParam.options = optimoptions('fmincon','Display','iter','MaxFunctionEvaluations',1000000,...
